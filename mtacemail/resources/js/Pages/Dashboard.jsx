         ...
         <aside className="left-sidebar">
             <div>
                 <div className="brand-logo d-flex align-items-center justify-content-between">
                     ...
                     >
                         <img
                             src="/assets/dashboard/images/logos/logo-light.svg"
                             alt=""
                         />
                     </a>
                     <div
                 ...
                 >
                     <ul id="sidebarnav">
                         ...
                         <li className="nav-small-cap">
                             <iconify-icon
                                 icon="solar:menu-dots-linear"
                                 className="nav-small-cap-icon fs-4 fs-6"
                             ></iconify-icon>
                     ...
                     >
                         <ul className="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                             ...
                             <li className="nav-item dropdown">
                                 ...
                                 >
                                     <img
                                         src="/assets/dashboard/images/profile/user-1.jpg"
                                         alt=""
                                         width="35"
                                         height="35"
                         ...
                         <div className="card">
                             <div className="card-body text-center">
                                 ...
                                 <p className="card-subtitle mt-2 mb-3">
                                     Duis at orci justo nulla in libero
                                     id leo molestie sodales phasellus
                                     justo.
                                 </p>
                         ...
                         <div className="card overflow-hidden hover-img">
                             ...
                             <div className="card-body p-4">
                                 ...
                                 <a
                                     ...
                                     href=""
                                 >
                                     As yen tumbles, gadget-loving Japan
                                     goes for secondhand iPhones
                                 </a>
                         ...
                         <div className="card overflow-hidden hover-img">
                             ...
                             <div className="card-body p-4">
                                 ...
                                 <a
                                     ...
                                     href=""
                                 >
                                     Intel loses bid to revive antitrust
                                     case against patent foe Fortress
                                 </a>
                                 <div className="d-flex align-items-center gap-4">
                                     <div className="d-flex align-items-center gap-2">
                                         <i className="ti ti-eye text-dark fs-5"></i>
                         ...
                         <div className="card overflow-hidden hover-img">
                             ...
                             <div className="card-body p-4">
                                 ...
                                 <a
                                     ...
                                     href=""
                                 >
                                     COVID outbreak deepens as more
                                     lockdowns loom in China
                                 </a>
                                 <div className="d-flex align-items-center gap-4">
                                     <div className="d-flex align-items-center gap-2">
                                         <i className="ti ti-eye text-dark fs-5"></i>
